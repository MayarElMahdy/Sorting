...
import SortingTechqniques.BubbleSort;
import SortingTechqniques.Heap;
import SortingTechqniques.InsertionSort;
import SortingTechqniques.MergeSort;
import SortingTechqniques.QuickSort;
import SortingTechqniques.SelectionSort;
...
public class main {
	...
	private void initialize() {
		...
		lblOriginalArray.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 14));
		...
		lblSortedArray.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 14));
		...
		lblArraySize.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 14));
		...
		btnSort.setForeground(Color.PINK);
		btnSort.setBackground(Color.WHITE);
		btnSort.setFont(new Font("Source Sans Pro Semibold", Font.PLAIN, 14));
